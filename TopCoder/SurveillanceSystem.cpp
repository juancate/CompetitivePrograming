...
string SurveillanceSystem::getContainerInfo(string containers, vector <int> reports, int k) {
  n = containers.size();
  m = reports.size();
  r = reports;
  s = containers;
